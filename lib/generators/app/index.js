...
Generator.prototype.setupEnv = function setupEnv() {
  ...
  this.mkdir('app/js/mixin');
  this.mkdir('app/js/page');
  this.mkdir('app/js/service');
  this.mkdir('app/js/templates');
  this.mkdir('test');
  this.mkdir('test/spec');
  this.mkdir('test/spec/component');
  this.mkdir('test/spec/mixin');
  this.mkdir('test/spec/page');
  this.mkdir('test/spec/service');
  this.mkdir('test/spec/templates');
};
